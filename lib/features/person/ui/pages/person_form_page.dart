              ...
              CrayonCard(
                child: Column(
                  ...
                  children: [
                    ...
                    const SizedBox(height: CrayonTheme.spacingMd),
                    _buildDropdownField('性别', ['男', '女', '其他'], _gender, (v) => setState(() => _gender = v)),
                    const SizedBox(height: CrayonTheme.spacingMd),
                    _buildDateField('出生日期', _birthDate, _selectDate),
                  ],
                ),
              ),
              const SizedBox(height: CrayonTheme.spacingMd),
              ...
              CrayonCard(
                child: Column(
                  ...
                  children: [
                    ...
                    const SizedBox(height: CrayonTheme.spacingMd),
                    _buildDropdownField('与本人的关系', ['本人', '配偶', '父亲', '母亲', '子女', '其他'], _relationship, (v) => setState(() => _relationship = v)),
                  ],
                ),
              ),
  ...
  Widget _buildDropdownField(String label, List<String> items, String? value, ValueChanged<String?> onChanged) {
    return Column(
      ...
      children: [
        Row(
          children: [
            Text(label, style: const TextStyle(color: CrayonTheme.darkBrown, fontWeight: FontWeight.w500, fontSize: 14)),
        ...
        GestureDetector(
          ...
          child: Container(
            ...
            decoration: BoxDecoration(
              ...
              borderRadius: BorderRadius.circular(CrayonTheme.radiusSm),
              border: Border.all(color: CrayonTheme.darkBrown.withValues(alpha: 0.5), width: 1.5),
            ),
            child: Row(
              mainAxisAlignment: MainAxisAlignment.spaceBetween,
              children: [
                Text(value ?? '请选择', style: const TextStyle(color: CrayonTheme.darkBrown, fontSize: 14)),
                const Icon(Icons.unfold_more, size: 20, color: CrayonTheme.forestGreen),
              ],
            ),
          ),
        ),
            ...
            child: Row(
              ...
              children: [
                Text(
                  ...
                  style: const TextStyle(color: CrayonTheme.darkBrown, fontSize: 14),
                ),
                const Icon(Icons.unfold_more, size: 20, color: CrayonTheme.forestGreen),
              ],
            ),
